...
var mailHtml, subject, sspName, mailText, mailEnd;
...
exports.generateMail = function (language, userName, hostName, sid) {
	...
	if (language == "en" || !language){
		...
		mailEnd = `<p style="Margin-top: 20px;Margin-bottom: 0;">Sincerely,<br>${sspName} Team</p>
        <p class="size-8" style="mso-text-raise: 9px;Margin-top: 20px;Margin-bottom: 0;font-size: 8px;line-height: 14px;" lang="x-size-8">
        This email was automatically sent by Sugarizer School Portal.</p>`;
        ...
        If already verified click ${hreflogin} to login ${mailEnd}`;
	} else if (language == "hi"){
		...
		mailEnd = `<p style="Margin-top: 20px;Margin-bottom: 0;">भवदीय,<br>${sspName} टीम</p>
        <p class="size-8" style="mso-text-raise: 9px;Margin-top: 20px;Margin-bottom: 0;font-size: 8px;line-height: 14px;" lang="x-size-8">
        यह ईमेल स्वचालित रूप से सुगराइज़र स्कूल पोर्टल कि तरफ़् से भेजा गया था</p>`;
        ...
        अगर पहले से सत्यापित है, तो ${hreflogin} क्लिक करें लॉगिन करने के लिए ${mailEnd}`;
	} else if (language == "fr") {
    ...
    '<strong>' + sspName + '</strong></h2></div></div>' +
    '<div style="Margin-left: 20px;Margin-right: 20px;">' +
    '<div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">' +
    mailText + '</div>' + '</div>' + '</div>';
