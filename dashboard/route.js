...
module.exports = function(app, ini) {
	...
	app.get('/deployments/dropdb/:did', authController.validateSession, authController.checkRole(deploymentsController.deleteDatabase));
	app.post('/deployments/dropdb/:did', authController.validateSession, authController.checkRole(deploymentsController.deleteDatabase));
